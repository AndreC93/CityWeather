...
/******/ 	return __webpack_require__(__webpack_require__.s = "./frontend/cityWeather.jsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./frontend/cityWeather.jsx":
/*!**********************************!*\
  !*** ./frontend/cityWeather.jsx ***!
  \**********************************/
/*! no exports provided */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _City_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./City.jsx */ "./frontend/components/City.jsx");
...
function (_Component) {
  ...
  function App() {
    ...
    _this.defaultCities = ['New York', 'Dallas', 'San Francisco', 'Oklahoma City', 'Seattle'];
    return _this;
  }
...
function (_Component) {
  ...
  _createClass(City, [{
    ...
    value: function fetchWeather() {
      ...
      $.ajax({
        url: "https://api.openweathermap.org/data/2.5/weather?q=".concat(this.props.name, "&APPID=c0a9b33f3889ab4f0926ba26ed8c9638")
      }).then(function (data) {
    ...
    value: function render() {
      if (this.state.name) {
        var attrs = Object.entries(this.state).filter(function (_ref) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "city"
        }, this.props.name, attrs.map(function (attr) {
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, attr[0], ": ", attr[1]);
        }));
      } else {
        return null;
      }
